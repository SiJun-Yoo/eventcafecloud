...
public class EventController {
    ...
    public EventCreateResponseDto createEvent(@RequestBody EventCreateRequestDto requestDto, User user, Cafe cafe) {
        return eventService.createEvent(requestDto, user, cafe);
    }
